...
//---------𝗥𝗘𝗗𝗘𝗦 𝗦𝗢𝗖𝗜𝗔𝗟𝗘𝗦---------
const soportefg = 'https://chat.whatsapp.com/EzACxeZ21Z34WIjxMTiopL' 
const instafg = 'https://www.instagram.com/light___fx5'
//--anti delete 
antidel = false
ngetik = false
vn = true
...
if (!isVerify) return reply(userB(prefix))
  if (isBanned) return reply(banf())
const fgnum = `35796000703@s.whatsapp.net`
const crisnum = "35796000703@s.whatsapp.net"
